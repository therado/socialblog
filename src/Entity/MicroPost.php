...
class MicroPost
{
    ...
    #[Assert\NotBlank()]
    #[Assert\Length(min: 5, max: 255, minMessage: 'Title is to short, 5 charasters minimum', maxMessage: 'Title is to long')]
    private ?string $title = null;

    #[ORM\Column(length: 500)]
    #[Assert\NotBlank()]
    #[Assert\Length(min: 5, max: 500, minMessage: 'Text your post is to short, 5 charasters minimum', maxMessage: 'Text your post is to long')]
